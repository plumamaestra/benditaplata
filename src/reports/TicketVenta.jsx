...
const TicketVenta = async (output, data) => {
  ...
  const content = [
    ...
    //QR FACTURA
    {
      stack: [
        {
          qr: `${data.dataempresa?.rnc}|${data.dataventas?.nro_comprobante}|${data.dataventas.monto_total}|${data.dataventas?.sub_total}|${data.dataventas?.total_impuestos}|${fecha}${hora}|`,
          fit: 115,
          alignment: "center",
          eccLevel: "Q",
          margin: [0, 10, 0, 3],
